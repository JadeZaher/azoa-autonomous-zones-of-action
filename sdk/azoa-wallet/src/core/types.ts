...
// To add a new chain: implement this interface in sdk/azoa-wallet/src/<chain>/provider.ts
...
export interface ChainProvider {
  ...
  // via AzoaApiClient.bridge.*, but providers CAN implement client-side bridge logic.
...
// ─── Provider Registry ───
// Used by AzoaWallet to discover registered chain providers.
