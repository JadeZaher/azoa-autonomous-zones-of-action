 ...
 *
 * The factory is created per-`AzoaApiClient` by {@link createQuestFactory}; the
 * facade exposes the bound instance as `azoa.workflow.quest`.
 */
...
export function createQuestFactory(api: AzoaApiClient): QuestFactory {
