...
import type { AzoaWallet } from "../wallet.js";
...
export class PortfolioAggregator {
  ...
  private readonly wallet: AzoaWallet;

  constructor(api: AzoaApiClient, wallet: AzoaWallet) {
    this.api = api;
    this.wallet = wallet;
  }
   ...
   * Queries the AZOA API for wallet list, then queries each chain provider
   * for live balances.
   */
