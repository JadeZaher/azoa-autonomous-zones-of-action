...
// Oasis.SurrealDb.Client -- C#-first schema authoring attribute surface.
//
// These attributes decorate POCOs in the consumer project. The
// Oasis.SurrealDb.Schema package scans them at build/CLI time and emits
...
namespace Oasis.SurrealDb.Client.Schema
{
    ...
    /// <c>SCHEMAFULL</c>; defaults to <c>true</c> per the OASIS G6 guardrail.
    /// </remarks>
