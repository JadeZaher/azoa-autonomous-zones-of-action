...
// Azoa.SurrealDb.Client -- marker interface implemented by every SurrealDB POCO.
// The POCOs are hand-authored under Persistence/SurrealDb/Models/ and decorated
// with [SurrealTable]; the AttributeSchemaScanner in Azoa.SurrealDb.Schema
...
namespace Azoa.SurrealDb.Client
{
    ...
    /// (the target framework for the Azoa.SurrealDb suite and any
