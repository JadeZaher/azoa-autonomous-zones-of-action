...
// Oasis.SurrealDb.Schema -- Minimal connection abstraction for the migration
// runner.
//
// Why a local interface? Phase 4 ships before A1/A2's full
// `Oasis.SurrealDb.Client` API freezes (A1 is still bootstrapping
...
// method) and the OASIS CLI bridges Oasis.SurrealDb.Client.ISurrealConnection
...
namespace Oasis.SurrealDb.Schema.Migration
{
    ...
    ///   - Adapter over <c>Oasis.SurrealDb.Client.HttpSurrealConnection</c> (production).
