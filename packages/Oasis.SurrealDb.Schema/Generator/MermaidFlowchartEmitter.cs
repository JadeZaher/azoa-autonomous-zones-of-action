...
// Oasis.SurrealDb.Schema -- Mermaid flowchart emitter (C#-first pivot).
//
...
// matching the visual idiom the OASIS team prefers for node/relationship
// portfolios:
//
//   graph LR
//       %% Define Nodes
...
namespace Oasis.SurrealDb.Schema.Generator
{
    ...
    public static class MermaidFlowchartEmitter
    {
            ...
            IReadOnlyList<RelationshipKey> edges)
        {
            ...
            sb.Append("    %% Regenerate with: dotnet run --project packages/Oasis.SurrealDb.Schema -- flowcharts\n");
            ...
            IReadOnlyList<RelationshipKey> edges)
        {
            ...
            var sb = new StringBuilder();
            sb.Append("graph LR\n");
            sb.Append("    %% OASIS Sleek -- domain data model (master flowchart)\n");
            sb.Append("    %% GENERATED FILE -- do not edit. Source: SurrealDB schema attribute scan.\n");
            sb.Append("    %% Regenerate with: dotnet run --project packages/Oasis.SurrealDb.Schema -- flowcharts\n");
            sb.Append("    %% \n");
