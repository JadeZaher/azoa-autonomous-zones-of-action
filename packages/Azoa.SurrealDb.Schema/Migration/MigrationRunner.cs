...
// Azoa.SurrealDb.Schema -- Migration runner (Phase 4 task 23).
//
// What this is:
...
namespace Azoa.SurrealDb.Schema.Migration
{
    ...
    public sealed class MigrationRunner
    {
        ...
        /// Defaults to <c>"azoa-surreal/cli"</c>.
        /// </param>
        ...
        /// <c>AzoaSurrealDbOptions.Connection.Namespace</c> and have the
            ...
            string? ensureDatabase = null)
        {
            ...
            _appliedBy = string.IsNullOrWhiteSpace(appliedBy) ? "azoa-surreal/cli" : appliedBy!;
