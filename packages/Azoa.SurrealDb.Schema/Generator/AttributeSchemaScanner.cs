...
// Azoa.SurrealDb.Schema -- C#-first attribute scanner.
//
// Reflects over a set of POCO types decorated with the
// Azoa.SurrealDb.Client.Schema.* attributes and projects them onto the
...
namespace Azoa.SurrealDb.Schema.Generator
{
    ...
    public static class AttributeSchemaScanner
    {
        ...
        private static string ResolveColumnName(PropertyInfo prop, ColumnAttribute? column)
        {
            ...
            return Azoa.SurrealDb.Client.Schema.SurrealNaming.ToColumnName(prop.Name);
        }
