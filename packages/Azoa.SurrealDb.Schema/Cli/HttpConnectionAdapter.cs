...
// Azoa.SurrealDb.Schema -- HTTP `POST /sql` adapter for the CLI.
//
// Why this lives in the Schema package rather than Client:
//   The CLI is shipped from `Azoa.SurrealDb.Schema.csproj` (PackAsTool). The
...
//   replacement for `Azoa.SurrealDb.Client.HttpSurrealConnection` (A1's
...
namespace Azoa.SurrealDb.Schema.Cli
{
    ...
    /// <c>Azoa.SurrealDb.Client.HttpSurrealConnection</c>.
    /// </summary>
