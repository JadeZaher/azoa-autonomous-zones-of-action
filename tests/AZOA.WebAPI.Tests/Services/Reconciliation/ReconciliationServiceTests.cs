...
public class ReconciliationServiceTests
{
    ...
    private sealed class FakeReconHarness : IDisposable
    {
        ...
        /// successful <c>AZOAResult</c> carrying the given status dictionary.</summary>
        ...
        /// errored <c>AZOAResult</c> (tx not found / RPC error — ambiguous).</summary>
        ...
        {
            // value-path-wiring H4: all value amounts are ulong; direct chain calls
            // also carry a trailing SigningContext? parameter.
