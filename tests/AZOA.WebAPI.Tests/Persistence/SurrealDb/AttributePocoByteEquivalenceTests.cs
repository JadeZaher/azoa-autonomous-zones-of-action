...
// AZOA.WebAPI.Tests -- byte-equivalence acceptance gate for the C#-first
...
namespace AZOA.WebAPI.Tests.Persistence.SurrealDb
{
    public class AttributePocoByteEquivalenceTests
    {
        ...
        public static TheoryData<Type, string> AllAttributedPocos()
        {
            ...
            var asm = typeof(AZOA.WebAPI.Persistence.SurrealDb.Models.Wallet).Assembly;
        ...
        public void Poco_emit_matches_committed_surql_byte_for_byte(Type pocoType, string tableName)
        {
            ...
            // Regen escape hatch: setting AZOA_REGENERATE_GOLDENS=1 OR
            ...
            // developer-only path.
            var regen = Environment.GetEnvironmentVariable("AZOA_REGENERATE_GOLDENS") == "1";
